function scaled_out = calib_factor(xdim , ydim , VCT_sens , theta_m , normalization , BIN_NUM)

% KNLEE: I removed TotalCounts b/c it does not make any effect on Calibration Factor
